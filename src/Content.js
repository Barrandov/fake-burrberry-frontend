...
<div>
  ...
  <section className="product__delivery">
    <div className="row">
      <div className="col-md-7">
        <img src={delivery} className="product__delivery-image" alt="Delivery information" />
      </div>
  ...
  <section className="product__related">
    ...
    <div className="row">
      ...
      <div className="col-xs-6 col-sm-3 col-md-3">
        <a className="product__related-card" href="#">
          <img src={relatedItem2} className="product__related-image" alt="Relaxed Fit Stretch Jeans" />
      ...
      <div className="col-xs-6 col-sm-3 col-md-3">
        <a className="product__related-card" href="#">
          <img src={relatedItem3} className="product__related-image" alt="Leather and House Check" />
      ...
      <div className="col-xs-6 col-sm-3 col-md-3">
        <a className="product__related-card" href="#">
          <img src={relatedItem4} className="product__related-image" alt="Leather Wingtip Check" />
